...
/**
 * @covers \App\ServiceFactory\RequestHandler\Api\Crud\ArticleUpdateRequestHandlerFactory
 *
 * @internal
 */
final class ArticleUpdateRequestHandlerFactoryTest extends TestCase
{
    public function testInvoke(): void
    {
        ...
        $factory = new ArticleUpdateRequestHandlerFactory();
